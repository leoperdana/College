			...
			(
				...
				{     
					...
					$scope.Submit = function()
					{
						...
						var strUrlDoEditCoursesService = "${pageContext.request.contextPath}/doeditcoursessvc/" + iCoursesId;
						
						$http.post(strUrlDoEditCoursesService, mParam).success
						(
							function(mResponse)
							{
								if(!mResponse.status)
					...
					var strUrlEditCoursesService = "${pageContext.request.contextPath}/editcoursessvc/" + iCoursesId;
					
					$http.get(strUrlEditCoursesService).success
					(
						function(mResponse)
						{
							if(!mResponse.status)
							...
							$scope.courses = 
							{
								name : mResponse.result.coursesname,
								credit : mResponse.result.coursescredit
							};
						}
					);
				}
	...
	<body ng-app="page">
		<div class="place" ng-controller="CoursesController">
			<form name="frmCourses">
				<div class="title">Edit Courses</div>
				<div class="component">
